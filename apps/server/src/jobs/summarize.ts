...
- 추측이나 과장된 표현은 사용하지 마.
- 절대 제목으로만 내용을 유추하지 말고, 글을 꼼꼼히 읽고 분석해서 핵심을 파악해서 작성해.

[섹션 작성 규칙]
- 핵심 내용을 담은 1줄 제목과, 배경과 문제 정의부터 핵심 개념, 구현 방법, 실무 시사점까지 5~8문장으로 서술한 본문으로 구성된 섹션을 3개 작성해.
- 각 섹션의 본문은 150~200자 이내로 작성해.
  ...
  "sections": [
    {
      ...
      "body": "배경과 문제 정의부터 핵심 개념, 구현 방법, 실무 시사점까지 5~8문장으로 서술해. 150~200자 이내."
    },
    {
      "title": "핵심 내용을 담은 1줄 제목",
      "body": "위와 동일한 기준. 5~8문장, 150~200자 이내"
    },
    {
      "title": "핵심 내용을 담은 1줄 제목",
      "body": "위와 동일한 기준. 5~8문장, 150~200자 이내"
